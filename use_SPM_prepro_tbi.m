...
subjects_s1=hc_subjects(Idx_s1); subjects_s2=hc_subjects(Idx_s2); subjects_s3=hc_subjects(Idx_s3);  

% Do preprocess
% SPM0_Initialise(indir, outdir, subjects_s2(1:end))
SPM_prepro_wrapper(subjects_s1(1),outdir)
